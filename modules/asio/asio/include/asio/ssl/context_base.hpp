...
public:
  ...
  ASIO_STATIC_CONSTANT(long, allow_unsafe_legacy_renegotiation = SSL_OP_ALLOW_UNSAFE_LEGACY_RENEGOTIATION);
  ASIO_STATIC_CONSTANT(long, no_session_resumption_on_renegotiation = SSL_OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION);
